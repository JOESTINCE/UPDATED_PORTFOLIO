      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="space-y-8">
          {experiences.map((exp, index) => (
            <Card key={index} className="hover:shadow-lg hover:shadow-red-600/20 transition-all duration-300 hover:scale-105 animate-fade-in border-l-4 border-l-red-600 bg-gray-800 border-red-600/30 hover:border-red-500">
              <CardHeader>
                <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                  ...
                  <Badge variant="outline" className="border-red-600 text-red-300 mt-2 md:mt-0 w-fit">
                    {exp.period}
                  </Badge>
                </div>
              </CardHeader>
